...
const attachAudio = require("./audio.js");
const attachServer = require("./server.js");
...
module.exports = function (homebridge) {
  ...
  attachAudio(SecuritySystem, Characteristic);
  attachServer(SecuritySystem, Characteristic, originTypes);
